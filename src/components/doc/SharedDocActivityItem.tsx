...
import { deleteSharedDocApi, getSharedViewLink } from "../../api/doc/docApi";
import Loader from "../loader/Loader";
import { downloadFileHandler } from "../../util/util";


const SharedDocActivityItem: React.FC<any> = ({ item, fetchData }) => {
    ...
    const deleteDocomentHandler = async () => {
        ...
        try {
            ...
            console.error('Error deleteDocApi :', error.response.data);
        } finally {
            setIsLoading(false);
        }
    };
...
export default SharedDocActivityItem;